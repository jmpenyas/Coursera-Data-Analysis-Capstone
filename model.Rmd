...
enUs.sample <- str_replace_all(enUs.sample, "[^[:alpha:][:space:]]*" , "")
enUs.sample <- str_replace_all(enUs.sample, "http[^[:space:]]*" , "")
enUs.sample <- str_replace_all(enUs.sample, "\\b(?=\\w*(\\w)\\1)\\w+\\b"  , "")
enUs.sample <- iconv(enUs.sample, to = "ASCII",sub = "")
