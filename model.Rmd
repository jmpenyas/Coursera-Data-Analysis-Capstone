...
tetragrams.df$word1 <- sapply(tetragrams.df$word1,stemDocument)
tetragrams.df$word2 <- sapply(tetragrams.df$ngrams, getWord, 2)
tetragrams.df$word2 <- sapply(tetragrams.df$word2,stemDocument)
tetragrams.df$word3 <- sapply(tetragrams.df$ngrams, getWord, 3)
tetragrams.df$word3 <- sapply(tetragrams.df$word3,stemDocument)
